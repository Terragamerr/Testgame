...
# bot init
bot = Bot(token='5352337481:AAEd8OZeI4Kv0fXE4CaqTolyvOCCAAlTSRk')
dp = Dispatcher(bot)
...
🗯 | <a href="https://t.me/warkraftGame_chat">Наш общий чатик</a>  там ты можешь:
   ✨ | Свободно играть в бота
   🥂 | Искать пару
   🎯 | Находить друзей
   💸 | Побеждать в розыгрыше и т.д
   
📢 | <a href="https://t.me/warkraftGame_info">Общий чат</a>\n там ты можешь:
